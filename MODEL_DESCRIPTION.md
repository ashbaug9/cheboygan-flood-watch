...
**Status:** Active Emergency Reference â€” READY Alert
...
3. **Compare water surface to ground** at every sampled point â€” areas where the water surface exceeds the ground elevation by the zone threshold are included in that zone
...
| Attenuation exponent Î³ | 0.35 | 0.25 |
...
```
WSE(d) = WSE_bc + (WSE_dam âˆ’ WSE_bc) Ã— (1 âˆ’ d/L)^Î³
```
...
- `Î³` = attenuation exponent (0.35 partial, 0.25 full)
...
- Manning's n (floodplain): 0.080 (urban â€” buildings, streets, lawns)
...
A partial breach at 17,500 cfs represents **19Ã— the normal channel capacity**. A full breach at 25,000 cfs represents **27Ã— normal capacity**. Both scenarios produce immediate and widespread overbank flooding.
...
|---|---|---|
| Zone 1 â€” Evacuate | > 4.0 ft above ground | Life-threatening. Vehicles swept away. Structural damage. No safe shelter at ground level. |
| Zone 2 â€” High Risk | 2.0 â€“ 4.0 ft | Vehicles impassable. Significant structural damage. Dangerous for adults. |
| Zone 3 â€” Watch | 0.5 â€“ 2.0 ft | Dangerous for children, elderly, mobility-limited persons. Vehicles may stall. |
...
- Michigan DNR lock specifications (16 ft wide Ã— 75 ft long vessels, 5 ft draft)
...
```
câ‚€ = âˆš(g Ã— hâ‚€)  where hâ‚€ = initial water depth behind dam
```

At current reservoir head (~12.5 ft): câ‚€ â‰ˆ 20 ft/s (13.6 mph)

| Zone | Partial Breach | Full Breach |
|---|---|---|
| Zone 1 (0â€“300 ft) | 0â€“15 minutes | 0â€“4 minutes |
| Zone 2 (300â€“800 ft) | 30â€“90 minutes | 2â€“8 minutes |
| Zone 3 (up to 0.4 mi) | 1.5â€“3 hours | 5â€“20 minutes |
...
1. **GPS-confirmed anchors** from fishweb.com Michigan Inland Waterway navigation markers:
   - Dam: N45Â°38.164â€² W84Â°28.777â€² (verified against Google Maps satellite)
   - Flow projection point: N45Â°36.372â€² W84Â°47.933â€² (55.4Â° NE bearing, Google Maps confirmed)
   - State Street access: N45Â°38.678â€² W84Â°28.469â€²
   - River mouth: N45Â°40.01â€² W84Â°27.22â€²

2. **OpenStreetMap Overpass API** â€” fetched at page load from `overpass-api.de`. OSM contributors have precisely traced the Cheboygan River centerline from aerial imagery, producing the same centerline visible as a dotted line in Google's satellite and hybrid views. If the OSM fetch succeeds, it replaces the interpolated fallback RCL while preserving the GPS-confirmed anchors at the dam and mouth.
...
### 1. Static inundation â€” not time-stepped
The model shows peak worst-case inundation extent. It does not simulate the flood wave moving through the city in time steps. The zone boundaries represent the *maximum extent* the flood could reach at peak discharge â€” not where the water is at any given minute after breach.
...
Current rainfall (forecast 1â€“2.5" Monday April 13) is not added to the breach discharge. The saturation correction (+0.5 ft) partially accounts for pre-existing soil moisture reducing infiltration, but the runoff volume from Monday's rain is not included in Qp.
...
The hydraulic model uses IGLD85 lake level data (Lake Huron = 581.0 ft). USGS 3DEP elevations are NAVD88. The difference between IGLD85 and NAVD88 at this location is approximately 0.5â€“1.0 ft. This offset is partially absorbed by the saturation correction but introduces a systematic uncertainty of roughly Â±0.5 ft in the absolute inundation depths.
...
The City of Cheboygan released a Safety Zone map on April 10, 2026 showing a narrow corridor (one to two blocks) along the river as the cautionary zone. That map reflects **current riverbank overflow risk** from elevated water levels under active mitigation â€” not a dam breach scenario. The FEMA Special Flood Hazard Area for a maintained USACE navigation channel in flat urban terrain is inherently narrow.

This model addresses a different and more severe question: **what happens if the dam structure fails?** The wider zones in this model are not in conflict with the city's map â€” they answer different questions.
...
The Ready/Set/Go trigger levels (READY at 12", SET at 6", GO at 1" below crest) are the official thresholds established by the emergency management authority â€” not derived from this model.
